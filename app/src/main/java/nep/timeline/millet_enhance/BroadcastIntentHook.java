                ...
                protected void beforeHookedMethod(XC_MethodHook.MethodHookParam param) {
                    try {
                        ...
                        if (intent != null) {
                            ...
                            boolean isFCM = action.endsWith(".android.c2dm.intent.RECEIVE") || "com.google.firebase.MESSAGING_EVENT".equals(action) || "com.google.firebase.INSTANCE_ID_EVENT".equals(action);
